...
@register_model_architecture('transformer_lm', 'gpt_6layer_384hidden_6head_1536ffn')
def transformer_lm_gpt_6_384(args):
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 384)
...
@register_model_architecture('transformer_lm', 'gpt_8layer_512hidden_8head_2048ffn')
def transformer_lm_gpt_6_384(args):
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 512)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 2048)
    args.decoder_layers = getattr(args, 'decoder_layers', 8)
...
@register_model_architecture('transformer_lm', 'gpt_10layer_640hidden_10head_2560ffn')
def transformer_lm_gpt_6_384(args):
...
@register_model_architecture('transformer_lm', 'gpt_11layer_704hidden_11head_2816ffn')
def transformer_lm_gpt_6_384(args):
    ...
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 11)
    args.dropout = getattr(args, 'dropout', 0.1)
    args.attention_dropout = getattr(args, 'attention_dropout', 0.1)
    args.activation_fn = getattr(args, 'activation_fn', 'gelu')
    base_lm_architecture(args)

@register_model_architecture('transformer_lm', 'gpt_12layer_768hidden_12head_3072ffn')
def transformer_lm_gpt_6_384(args):
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 768)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 3072)
    args.decoder_layers = getattr(args, 'decoder_layers', 12)
...
@register_model_architecture('transformer_lm', 'gpt_6layer_384hidden_6head_1024ffn')
def transformer_lm_gpt_6_384(args):
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 384)
...
@register_model_architecture('transformer_lm', 'gpt_6layer_768hidden_6head_1024ffn')
def transformer_lm_gpt_6_384(args):
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 768)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 1024)
    args.decoder_layers = getattr(args, 'decoder_layers', 6)
