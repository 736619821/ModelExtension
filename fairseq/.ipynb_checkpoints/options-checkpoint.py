...
def add_dataset_args(parser, train=False, gen=False):
    ...
    parser.add_argument('--dataset-impl', metavar='FORMAT',
                        choices=get_available_dataset_impl(),
                        help='output dataset implementation')
    group.add_argument('--extend', default=False, action='store_true',
                help='whether use extend')
    group.add_argument('--expand-hidden', default=False, action='store_true',
            help='whether use extend')
    group.add_argument('--expand-ffn', default=False, action='store_true',
            help='whether use extend')
    group.add_argument('--expand-head', default=False, action='store_true',
        help='whether use extend')
    group.add_argument('--expand-layer', default=False, action='store_true',
        help='whether use extend')
...
def add_optimization_args(parser):
    ...
    group.add_argument('--use_domain_prompt', default=False, action='store_true')
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--load-dir', metavar='DIR', default='load_checkponits',
                    help='path to load checkpoints')
    group.add_argument('--restore-file', default='checkpoint_last.pt', type=str, 
